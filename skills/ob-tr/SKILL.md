...
- 报告模板：`<skill目录>/templates/测试报告.md`
- 测试环境：同 test-case skill 步骤2，从 workspace-pm PROJECT.md 取
...
同 test-case skill 步骤2，取 testUrl、数据库、分支版本等。
...
3. 用 `Write` 写到 `<vaultPath>/<kbDir>/tests/REQ-{编号}-{slug}-测试报告.md`
4. `$CLI reload`
